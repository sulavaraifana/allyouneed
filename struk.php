                    ...
                    <div class="card-body">
                        ...
                        <div class="row border-top">
                            <div class="col-6 py-2">
                                ...
                                <img class="rounded-3" src="images/<?= $d['image']?>" width="50%" alt="">
                            </div>
                        </div>
                        <a href="" class="btn btn-outline-success justify-content-right" id="cetak">Print</a>
                        <a href="customer.php" class="btn btn-outline-danger justify-content-right" id="cetak">Back</a>
                    </div>
                  
                    <div class="card-footer text-light text-center bg-secondary">
                        <h5>© 2022 kelompokkeren.com</h5>
                    </div>
                </div> 
