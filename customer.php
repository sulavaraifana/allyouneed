...
<?php
  ...
  <img src="images/<?= $data['image'] ?>" alt="" width="250px">
    ...
    <a href="" class="button " data-bs-toggle="modal"
                        data-bs-target="#beli<?= $data['id'] ?>" data-bs-whatever="@mdo">Buy Now</a>
	</figure>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="beliaksi.php" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3">
                                    <input type="hidden" name="id" value="<?= $data['id'] ?>">
                                        <label for="recipient-name" class="col-form-label">Nama Barang:</label>
                                        <br>
                                        <label name="nama"  for="recipient-name"
                                            class="col-form-label"><?php echo $data['nama'] ?></label>

                                    </div>
                                    <div class="mb-3">
                                        <label for="recipient-name" class="col-form-label">Merek:</label>
                                        <br>
                                        <label name="merek"  for="recipient-name"
                                            class="col-form-label"><?php echo $data['merek'] ?></label>
                                    </div>
                                    <div class="mb-3">
                                        <label for="recipient-name" class="col-form-label">harga:</label>
                                        <br>
                                        <label  name="harga" for="recipient-name"
                                            class="col-form-label">Rp.<?=number_format($data['harga'],2)?></label>
                                    </div>
                                    <div class="mb-3">
                                        <label for="recipient-name" class="col-form-label">stok:</label>
                                        <label  name="stok" for="recipient-name"
                                            class="col-form-label"><?php echo $data['stok'] ?></label>
                                    </div>
                                    <div class="mb-3">
                                        <label for="recipient-name" class="col-form-label">Kuantitas:</label>
                                        <br>
                                        <input name="stok"  type="number" id="quantity" >
                                    </div>
                                    <button type="submit" class="btn btn-success " value="simpan">beli</button>
                                </form>
                            </div>
